...
PRODUCTS = [
    ...
    dict(
        ...
        type=ProductType.CORE, price_cents=49900, currency="THB",
        status=ProductStatus.PUBLISHED,
    ...
    dict(
        ...
        type=ProductType.CORE, price_cents=149000, currency="THB",
        status=ProductStatus.PUBLISHED,
    ...
    dict(
        ...
        type=ProductType.CORE, price_cents=0, currency="THB",
        status=ProductStatus.PUBLISHED,
...
ORDERS = [
    ...
    (1, 2, 49900, OrderStatus.FULFILLED, 25),
    (2, 1, 99000, OrderStatus.FULFILLED, 22),
    (3, 2, 49900, OrderStatus.FULFILLED, 20),
    (4, 1, 99000, OrderStatus.FULFILLED, 18),
    (5, 3, 149000, OrderStatus.FULFILLED, 15),
    (0, 1, 99000, OrderStatus.FULFILLED, 14),
    (6, 2, 49900, OrderStatus.PAID, 3),
    (7, 1, 99000, OrderStatus.PAID, 2),
    (1, 1, 99000, OrderStatus.PENDING, 0),
    (2, 2, 49900, OrderStatus.REFUNDED, 12),
