...
async def test_mas_autonomy():
    ...
    goal = (
        "Analyze the competitive landscape of personal AI assistants and draft a blog post summary."
    )
    ...
    logger.info(
        "✅ Verification script finished. Check 'agent_tasks' and 'agent_messages' tables for proof of life."
    )
