...
**Also resolved same day:** a "MEGA_PLAN v3 draft (2026-07-22)" is referenced by two orphaned errata files (`MEGA_PLAN_v3_ERRATA_20260722.md`, `MEGA_PLAN_v3_ERRATA_CORRECTION_20260725.md`) but **no v3 base document exists anywhere in this repository** — grepped, not found. Their substantive content (annualization-factor audit, cost-model-direction audit) is already incorporated here as F15/F16. Treat v3 as an abandoned/never-finalized draft; this v2 document remains canonical. `Meta/graxia_mega_plan_v3.md` is a **different, unrelated document** (an older XAUUSD M15 profit-scaling plan, locked 2026-06-26) — despite the similar filename it is not part of this plan's lineage and is out of scope here.
