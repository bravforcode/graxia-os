...
class MLMeanReversion(Strategy):
    ...
    - BTCUSD: Best balanced model â†’ standard ML threshold
    - EURUSD: Moderate skew â†’ slightly lower threshold
    - XAUUSD/NAS100/US30: Heavy skew â†’ rely on technicals, ML as weak filter
    """
