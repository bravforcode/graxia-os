"""
FOMC Drift — Post-FOMC directional drift for XAUUSD.
...
- Dovish surprises (rate cuts, dovish guidance) → gold rallies
- Hawkish surprises (rate hikes, hawkish guidance) → gold sells off
...
- max_fomc_return    = 0.03  (max |return| — reject outlier moves)
