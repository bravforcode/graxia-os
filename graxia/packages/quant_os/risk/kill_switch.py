...
class KillSwitch:
    ...
    def _cmd_pause(self) -> str:
        self._set_state(
            ...
            reason="Telegram /pause — no new entries, closes allowed",
            authorized_by=f"telegram:{self._last_user_id}",
        )
        return "PAUSED — no new entries. Closes still allowed. /resume to restart."
    ...
    def _cmd_resume(self) -> str:
        ...
        self._state["killed_classes"] = []
        self._save()
        return "RESUMED — normal operation. All classes unblocked."
