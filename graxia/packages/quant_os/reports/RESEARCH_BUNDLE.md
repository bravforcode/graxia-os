...
| 2 | Pepperstone MetaTrader 5 | `C:\Program Files\Pepperstone MetaTrader 5\` | `73B7A2420D6397DFF9014A20F1201F97` | Pepperstone-Demo (login: 61547941) | MetaQuotes Ltd. |
...
| Operation | Result |
|-----------|--------|
| `mt5.initialize()` | ✅ Connected to Pepperstone-Demo (login 61547941) |
