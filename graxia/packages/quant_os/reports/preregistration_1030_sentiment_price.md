...
# Trial #1030 — Formal Hypothesis Registration
...
- Edge claim must cite: (1) trial_number=1030, (2) p-value or dk_t, (3) artifact path
...
- **Walk-forward result**: `reports/sentiment_price_walkforward_1030.json`
- **Validation report**: `reports/sentiment_price_validation_1030.md`
- **Hypothesis registry**: `research/hypothesis_registry.json` (trial 1030 entry)
