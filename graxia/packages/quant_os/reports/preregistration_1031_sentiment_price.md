...
# Trial #1031 — Formal Hypothesis Registration
...
- **Multiple testing correction**: Bonferroni against cumulative trial count (1029 prior trials)
  - Adjusted α = 0.05 / 1030 = 0.000049 (note: 1030 = 1029 prior + current)
  - This is conservative — reflects the reality that we've already run 1029 trials
- **Required evidence**: p-value < 0.000049 AND effect size (Cohen's d) > 0.2
...
- Edge claim must cite: (1) trial_number=1031, (2) p-value or dk_t, (3) artifact path
...
- **Walk-forward result**: `reports/sentiment_price_walkforward_1031.json`
- **Validation report**: `reports/sentiment_price_validation_1031.md`
- **Hypothesis registry**: `research/hypothesis_registry.json` (trial 1031 entry)

## Decision Criteria
- **PROCEED** if: p < 0.000049 AND Cohen's d > 0.2 AND direction consistency > 55%
- **REJECT** if: p >= 0.000049 OR Cohen's d <= 0.2
