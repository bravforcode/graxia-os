...
class QuantException(Exception):  # noqa: N818
    """Base exception for all Quant OS errors"""

    def __init__(self, message: str, error_code: str = "QUANT_ERROR", context: dict | None = None):
...
class RiskViolationError(QuantException):
    ...
    def __init__(self, message: str, violation_type: str = "", context: dict | None = None):
...
class ComplianceError(QuantException):
    ...
    def __init__(self, message: str, compliance_check: str = "", context: dict | None = None):
...
class KillSwitchTriggeredError(QuantException):
    ...
    def __init__(self, message: str, switch_type: str = "", context: dict | None = None):
...
class DataQualityError(QuantException):
    ...
    def __init__(self, message: str, check_type: str = "", context: dict | None = None):
...
class BrokerError(QuantException):
    ...
    def __init__(self, message: str, broker: str = "", context: dict | None = None):
...
class OverfittingError(QuantException):
    ...
    def __init__(self, message: str, test_failed: str = "", context: dict | None = None):
...
class InsufficientEvidenceError(QuantException):
    ...
    def __init__(self, message: str, missing_evidence: list | None = None, context: dict | None = None):
...
class OrderStateError(QuantException):
    ...
    def __init__(self, message: str, from_state: str = "", to_state: str = "", context: dict | None = None):
...
class DuplicateOrderError(QuantException):
    ...
    def __init__(self, message: str, idempotency_key: str = "", context: dict | None = None):
...
class PositionMismatchError(QuantException):
    ...
    def __init__(self, message: str, symbol: str = "", context: dict | None = None):
...
class StrategyError(QuantException):
    ...
    def __init__(self, message: str, strategy_id: str = "", context: dict | None = None):
...
class MLModelError(QuantException):
    ...
    def __init__(self, message: str, model_id: str = "", context: dict | None = None):
...
class DriftDetectedError(QuantException):
    ...
    def __init__(self, message: str, model_id: str = "", drift_score: float = 0.0, context: dict | None = None):
...
class CircuitBreakerError(QuantException):
    ...
    def __init__(self, message: str, breaker_type: str = "", context: dict | None = None):
...
class StrictMTFViolation(QuantException):
    ...
    def __init__(self, message: str = "strict_mtf enabled but no MTF cursor set", context: dict | None = None):
