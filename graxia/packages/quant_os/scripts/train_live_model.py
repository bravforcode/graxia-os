...
LIVE_FEATURES = [
    ...
    "willr_14",
    # Trend
    "ema_5_dist", "ema_10_dist", "ema_20_dist", "ema_50_dist", "ema_100_dist", "ema_200_dist",
...
EXCLUDE_COLS = {
    ...
    "target_class", "fwd_ret_1bar", "fwd_ret_5bar", "fwd_ret_10bar", "fwd_ret_15bar",
    ...
    "symbol", "freq",
    # Non-live features
    "datetime", "date", "log_return",
    # Cross-asset
    "gold_silver_ratio", "gold_silver_ratio_pct",
    "gold_dxy_corr_20", "gold_dxy_corr_60",
    "gold_oil_ratio", "gold_oil_ratio_pct",
    "gold_vix_corr_20", "vix_level",
    "gold_tlt_corr_20", "gold_sp500_corr_20", "gold_usdjpy_corr_20", "gold_btc_corr_20",
    # Macro (FRED)
    "real_yield_10y", "real_yield_10y_chg5d", "real_yield_10y_chg20d",
    "breakeven_10y", "breakeven_10y_chg5d",
    "yield_curve_10y2y", "yield_curve_10y2y_chg5d",
    "dollar_trade_weighted", "dollar_tw_chg5d", "dollar_tw_chg20d",
    "hy_spread", "hy_spread_chg5d", "hy_spread_zscore",
    "fed_balance_sheet", "fed_bs_chg_20d", "fed_bs_chg_60d",
    "rrp_level", "rrp_chg_20d",
    "ted_spread", "baa10y_spread",
    "fred_unrate", "fred_cpiaucsl", "fred_fedfunds", "fred_indpro", "fred_umcsent",
    # COT
    "cot_commercials_net_pct", "cot_managed_money_net_pct", "cot_managed_money_long_pct",
    "cot_managed_money_short_pct", "cot_managed_money_spread_pct", "cot_large_spec_net_pct",
    "cot_commercials_net_pct_chg1w", "cot_commercials_net_pct_chg4w",
    "cot_managed_money_net_pct_chg1w", "cot_managed_money_net_pct_chg4w",
    "cot_large_spec_net_pct_chg1w", "cot_large_spec_net_pct_chg4w",
    "cot_oi_change",
    "cot_commercials_net_pct_extreme_high", "cot_commercials_net_pct_extreme_low",
    "cot_managed_money_net_pct_extreme_high", "cot_managed_money_net_pct_extreme_low",
    # Cross-asset momentum
    "dxy_mom_5d", "dxy_mom_10d", "dxy_mom_20d", "dxy_vol_20d",
    "vix_mom_5d", "vix_mom_10d", "vix_mom_20d", "vix_vol_20d",
    "tlt_mom_5d", "tlt_mom_10d", "tlt_mom_20d", "tlt_vol_20d",
    "oil_mom_5d", "oil_mom_10d", "oil_mom_20d", "oil_vol_20d",
    "silver_mom_5d", "silver_mom_10d", "silver_mom_20d", "silver_vol_20d",
    "sp500_mom_5d", "sp500_mom_10d", "sp500_mom_20d", "sp500_vol_20d",
    "usdjpy_mom_5d", "usdjpy_mom_10d", "usdjpy_mom_20d", "usdjpy_vol_20d",
    "btc_mom_5d", "btc_mom_10d", "btc_mom_20d", "btc_vol_20d",
    "term_premium_10y5y", "term_premium_chg5d",
    # Regime
    "regime_vix_low", "regime_vix_high", "regime_vix_extreme",
    "regime_yieldcurve_inverted", "regime_yieldcurve_flat",
    "regime_dollar_strong", "regime_dollar_weak",
    "regime_credit_stressed",
    "regime_gold_bull", "regime_gold_bear",
}
        ...
        for train_idx, test_idx in walk_forward_cv(len(X), n_folds=3, embargo=12):
            ...
            model = cb.CatBoostClassifier(
                **params, random_seed=RANDOM_STATE,
                verbose=0, early_stopping_rounds=EARLY_STOP,
            )
...
def train_model_pipeline(
    ...
    study_lgb.optimize(make_lgb_objective(X_train, y_train), n_trials=N_TRIALS_LGB,
    ...
    study_cb.optimize(make_cb_objective(X_train, y_train), n_trials=N_TRIALS_CB,
                      show_progress_bar=False, callbacks=[progress_callback])
