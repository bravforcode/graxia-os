...
$utcTrigger = [DateTime]::new(2000, 1, 1, 13, 0, 0, [DateTimeKind]::Utc)
...
$settings = New-ScheduledTaskSettingsSet -MultipleInstances IgnoreNew -ExecutionTimeLimit (New-TimeSpan -Hours 5) -StartWhenAvailable
