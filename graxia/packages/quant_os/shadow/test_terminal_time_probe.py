            ...
            [
                {
                    ...
                    "timecurrent_struct": "2026-06-22 19:36:27",
                    "timetradeserver_raw": 1782156987,
                    "timetradeserver_struct": "2026-06-22 19:36:27",
                    "timelocal_raw": 1782146188,
                    "timelocal_struct": "2026-06-22 16:36:28",
                    "timegmt_raw": 1782146188,
                    "timegmt_struct": "2026-06-22 16:36:28",
                    "timegmtoffset_seconds": 0,
                    "tick_time_raw": 1782156987,
                    "tick_time_msc": 1782156987122,
                    "tick_bid": 4185.37,
                    "tick_ask": 4185.46,
                    "bar_time_raw": 1782154800,
                    "m1_time_raw": 1782156960,
                    "h1_time_raw": 1782154800,
                    "server_minus_gmt_seconds": 10800,
                    "tick_minus_timecurrent_ms": 0,
            ...
            [
                {
                    ...
                    "login": 1,
                    "terminal_build": 1,
                    "timecurrent_raw": 1000 + i,
                    "timecurrent_struct": "",
                    "timetradeserver_raw": 1000 + i,
                    "timetradeserver_struct": "",
                    "timelocal_raw": 1000 + i,
                    "timelocal_struct": "",
                    "timegmt_raw": 1000 + i,
                    "timegmt_struct": "",
                    "timegmtoffset_seconds": 0,
                    "tick_time_raw": 1000 + i,
                    "tick_time_msc": (1000 + i) * 1000,
                    "tick_bid": 0,
                    "tick_ask": 0,
                    "bar_time_raw": 1000 + i,
                    "m1_time_raw": 1000 + i,
...
class TestCopyTicksDiagnostic:
    ...
    def test_ticks_in_window(self):
        d = CopyTicksDiagnostic(
            ...
            first_epoch=100,
            last_epoch=200,
            ticks_in_window=True,
            ticks_outside_count=0,
        )
    ...
    def test_ticks_outside_window(self):
        d = CopyTicksDiagnostic(
            ...
            first_epoch=100,
            last_epoch=500,
            ticks_in_window=False,
            ticks_outside_count=3,
        )
        assert d.ticks_in_window is False
