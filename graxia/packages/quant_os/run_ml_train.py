...
def _shutdown_handler(signum: int, frame) -> None:
    """Set flag so the training loop exits cleanly."""
...
def main():
    ...
    if _shutdown_requested:
        print("Shutdown requested — aborting before feature engineering.")
        return
    ...
    if _shutdown_requested:
        print("Shutdown requested — aborting before model training.")
        return
    ...
    if _shutdown_requested:
        print("Shutdown requested — aborting before walk-forward.")
        return
