"""Test CME headline and tech roundup."""
...
headlines = [
    ("bloomberg", "CME's Duffy warns an overlooked tax risk looms over U.S. stock market"),
    ("techcrunch", "Top 5 tech and startup stories of the day"),
]
