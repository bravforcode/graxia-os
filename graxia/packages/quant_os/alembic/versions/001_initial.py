...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_audit_occurred_at", "quant_audit_log", [sa.text("occurred_at DESC")]
    )
    ...
    op.create_index(
        "ix_backtests_created_at", "quant_backtests", [sa.text("created_at DESC")]
    )
    ...
    op.create_index(
        "ix_dq_passed", "quant_data_quality_runs", ["passed", sa.text("ran_at DESC")]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "current_drawdown_pct", sa.Numeric(8, 4), nullable=False, server_default="0"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "portfolio_exposure_pct", sa.Numeric(8, 4), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        "ix_recon_run_date", "quant_reconciliation_logs", [sa.text("run_date DESC")]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "severity",
            sa.Enum("P0", "P1", "P2", "P3", name="incidentseverity"),
            nullable=False,
        ),
        sa.Column("symbol", sa.String(16), nullable=True),
        sa.Column("strategy_id", sa.String(64), nullable=True),
    ...
    op.create_index(
        "ix_risk_events_created_at", "quant_risk_events", [sa.text("created_at DESC")]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "signal_type",
            sa.Enum("BUY", "SELL", "NO_TRADE", "EXIT", "REDUCE", "HOLD", name="signaltype"),
            nullable=False,
        ),
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "NO_TRADE",
                "WAIT",
                "ABSTAIN_INSUFFICIENT_EDGE",
                "ABSTAIN_DATA_QUALITY",
                "ABSTAIN_RISK_LIMIT",
                "ABSTAIN_MARKET_CONDITION",
                name="decisiontype",
            ),
            nullable=True,
        ),
    ...
    op.create_index(
        "ix_signals_received_at", "quant_signals", [sa.text("received_at DESC")]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "backtest_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("quant_backtests.id"),
            nullable=False,
        ),
        sa.Column("symbol", sa.String(16), nullable=False),
    ...
    op.create_index(
        "ix_backtest_trades_backtest_id", "quant_backtest_trades", ["backtest_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "time_in_force",
            sa.Enum("DAY", "GTC", "IOC", "FOK", name="timeinforce"),
            nullable=False,
            server_default="DAY",
        ),
        sa.Column("strategy_id", sa.String(64), nullable=False),
        sa.Column(
            "signal_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("quant_signals.id")
        ),
    ...
    op.create_index(
        "ix_orders_created_at", "quant_orders", [sa.text("created_at DESC")]
    )
    ...
    op.create_index(
        "ix_risk_checks_created_at", "quant_risk_checks", [sa.text("created_at DESC")]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "order_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("quant_orders.id"), nullable=False
        ),
    ...
    op.create_index(
        "ix_state_history_order_id", "quant_order_state_history", ["order_id"]
    )
    op.create_index(
        "ix_state_history_occurred_at",
        "quant_order_state_history",
        [sa.text("occurred_at DESC")],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "exit_order_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("quant_orders.id")
        ),
    )
...
def downgrade() -> None:
    ...
    op.drop_table("quant_backtest_trades")
