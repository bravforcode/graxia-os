...
def test_min_btl_basic():
    ...
    result = min_backtest_length(observed_sharpe=3.0, n_trials=10, sharpe_annualization_factor=math.sqrt(252))
...
def test_min_btl_increases_with_trials():
    ...
    r1 = min_backtest_length(observed_sharpe=2.0, n_trials=10, sharpe_annualization_factor=math.sqrt(252))
    r2 = min_backtest_length(observed_sharpe=2.0, n_trials=1000, sharpe_annualization_factor=math.sqrt(252))
...
def test_min_btl_sufficient_data():
    ...
    result = min_backtest_length(
        observed_sharpe=3.0, n_trials=10, sharpe_annualization_factor=math.sqrt(252), current_observations=100000
    )
...
def test_min_btl_low_sharpe():
    ...
    result = min_backtest_length(observed_sharpe=0.01, n_trials=100, sharpe_annualization_factor=math.sqrt(252))
...
def test_min_btl_zero_trials():
    ...
    result = min_backtest_length(observed_sharpe=2.0, n_trials=0, sharpe_annualization_factor=math.sqrt(252))
...
def test_min_btl_negative_trials():
    ...
    result = min_backtest_length(observed_sharpe=2.0, n_trials=-5, sharpe_annualization_factor=math.sqrt(252))
    assert result.min_observations == 1


def test_min_btl_result_fields():
    """MinBTLResult has all expected fields."""
    result = min_backtest_length(observed_sharpe=2.0, n_trials=50, sharpe_annualization_factor=math.sqrt(252))
...
def test_min_btl_high_sharpe_low_trials():
    ...
    result = min_backtest_length(observed_sharpe=5.0, n_trials=5, sharpe_annualization_factor=math.sqrt(252))
...
def test_min_btl_expected_max_sharpe_positive():
    ...
    result = min_backtest_length(observed_sharpe=3.0, n_trials=100, sharpe_annualization_factor=math.sqrt(252))
...
def test_min_btl_z_threshold_at_95():
    ...
    result = min_backtest_length(
        observed_sharpe=3.0, n_trials=10, sharpe_annualization_factor=math.sqrt(252), confidence_level=0.95
    )
...
def test_min_btl_custom_confidence():
    ...
    r95 = min_backtest_length(observed_sharpe=3.0, n_trials=10, sharpe_annualization_factor=math.sqrt(252), confidence_level=0.95)
    r99 = min_backtest_length(observed_sharpe=3.0, n_trials=10, sharpe_annualization_factor=math.sqrt(252), confidence_level=0.99)
...
def test_min_btl_zero_sharpe():
    ...
    result = min_backtest_length(observed_sharpe=0.0, n_trials=10, sharpe_annualization_factor=math.sqrt(252))
...
def test_min_btl_negative_sharpe():
    ...
    result = min_backtest_length(observed_sharpe=-1.0, n_trials=10, sharpe_annualization_factor=math.sqrt(252))
    assert result.min_observations == 999_999_999
    assert result.sufficient is False
