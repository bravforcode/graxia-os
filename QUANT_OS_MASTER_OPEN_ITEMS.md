...
| 11 | Sizing bug (100x units→lots) — mt5.py fixed; `risk/engine.py::_layer4()` and `position_sizer_v2.py` wiring/single-source-of-truth status | **VERIFIED SINGLE-SOURCE 2026-08-07**: all 3 points use core/contract_specs.py (mt5.py L276, _layer4 L539, position_sizer_v2 no-inline). Out-of-scope: api/webhook.py L385 JPY 100000/100=1000 WRONG (path KNOWN BROKEN); broker_adapter.py L200 deprecated |
